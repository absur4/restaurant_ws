...
def build_state_machine():
    ...
    with sm:
        ...
        smach.StateMachine.add("NAVIGATE_TO_CUSTOMER", NavigateToCustomerState(), transitions={"success": "TAKE_ORDER", "failure": "MISSION_ABORTED"})
        smach.StateMachine.add("TAKE_ORDER", TakeOrderState(), transitions={"success": "NAVIGATE_TO_BAR", "failure": "MISSION_ABORTED"})
        smach.StateMachine.add("NAVIGATE_TO_BAR", NavigateToBarState(), transitions={"success": "REPORT_ORDER", "failure": "MISSION_ABORTED"})
        ...
        smach.StateMachine.add("NAVIGATE_BACK_TO_CUSTOMER", NavigateBackToCustomerState(), transitions={"success": "SERVE_ITEMS", "failure": "MISSION_ABORTED"})
